...
## Create the plot
p <-
    readr::read_csv("data/fig7-v1-g.csv") %>%
    dplyr::mutate(
        N = factor(N),
...
ggsave("figures/fig7-v1.eps", p, width = 6, height = 5)
ggsave("figures/fig7-v1.pdf", p, width = 6, height = 5)
