...
pts <-
    ...
    dplyr::filter((var1 == "y1" & var2 == "y2") | (var1 == "y3" & var2 == "y4"))
head(pts)
...
p <- 
    ...
    facet_wrap(var1 ~ var2, labeller = labeller(var1 = label_both, var2 = label_both)) +
    labs(
        x = "",
        y = "",
        colour = "group"
...
p    
ggsave("images/webfig6.pdf", p, width = 6, height = 5)
ggsave("images/webfig6.eps", p, width = 6, height = 5)