# Reproduce images/webfig7.(pdf/eps)
...
## Create the plot
p <-
    readr::read_csv("data/webfig6.csv") %>%
    dplyr::mutate(
        N = factor(N),
...
ggsave("images/webfig7.pdf", p, width = 6, height = 5)
ggsave("images/webfig7.eps", p, width = 6, height = 5)
