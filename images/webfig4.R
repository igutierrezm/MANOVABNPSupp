# Reproduce images/webfig4.(pdf/eps)
...
## Create the plot
p <-
    readr::read_csv("data/webfig4.csv") %>%
    dplyr::mutate(
        N = factor(N),
...
ggsave("images/webfig4.pdf", p, width = 6, height = 5)
ggsave("images/webfig4.eps", p, width = 6, height = 5)
