# Reproduce images/webfig5.(pdf/eps)
...
## Create the plot
p <-
    readr::read_csv("data/webfig5.csv") %>%
    dplyr::mutate(
        N = factor(N),
...
ggsave("images/webfig5.pdf", p, width = 6, height = 5)
ggsave("images/webfig5.eps", p, width = 6, height = 5)
