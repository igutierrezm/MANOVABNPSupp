...
cntrs <-
    readr::read_csv("data/box1950-variation1-f.csv") %>%
    dplyr::mutate(
...
p    
ggsave("images/box1950-variation1-f.pdf", p, width = 6, height = 5)
ggsave("images/box1950-variation1-f.eps", p, width = 6, height = 5)